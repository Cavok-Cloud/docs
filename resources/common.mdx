...
<Warning>
  Estimates are a **best-effort** feature, and there are no SLA covering its accuracy.

  Use it as a measure for our service value proposition, and always check your current cloud Cost Explorer.
</Warning>
